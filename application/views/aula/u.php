...
<div class="container content">
	...
	<option value="<?=$categoria->id?>"
					<?= $categoria->id==$aula->pertenece_id ? 'selected="selected"' : ''?>> <?=$categoria->nombre?> </option>
	<?php endforeach;?>
	</select>
		</div>

		<div class="input-field col s12">
			<label for="naula">Nombre</label> <input type="text"
				class="form-control" name="naula" id="naula">
		</div>

		<div class="input-field col s12">
			<label for="capacidad">Capacidad</label> <input type="text"
				class="validate" name="capacidad" id="capacidad">
		</div>

		<div class="input-field col s12">
			<label for="comnentarios">Comentarios</label> <input type="text"
				class="validate" name="comentarios" id="comentarios">
		</div>
