<div class="container content">
	...
	<form action="<?=base_url()?>usuario/registrarPost"
		...
		<div class="input-field col m12 s12">
			<label for="username">Nombre de usuario</label> <input id="username"
				type="text" name="username" class="">
		</div>

		<div class="input-field col m12 s12">
			<label for="pwd">Contraseña</label> <input id="pwd" type="password"
				name="pwd" class="">
		</div>
